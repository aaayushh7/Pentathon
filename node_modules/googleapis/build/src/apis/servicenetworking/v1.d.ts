...
export declare namespace servicenetworking_v1 {
    ...
    export interface Schema$RangeReservation {
         ...
         */
        subnetworkCandidates?: Schema$Subnetwork[];
    }
    /**
     ...
     */
    export interface Schema$UpdateConsumerConfigRequest {
        /**
         * Required. The updated peering config.
         */
        consumerConfig?: Schema$ConsumerConfig;
    }
    /**
    ...
    export interface Schema$ValidateConsumerConfigResponse {
         ...
         */
        existingSubnetworkCandidates?: Schema$Subnetwork[];
        /**
    ...
    export class Resource$Services$Projects$Global$Networks {
        ...
        updateConsumerConfig(callback: BodyResponseCallback<Schema$Operation>): void;
    }
