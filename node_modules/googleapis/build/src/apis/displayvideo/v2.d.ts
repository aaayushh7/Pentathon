...
export declare namespace displayvideo_v2 {
    ...
    export class Resource$Advertisers$Youtubeadgroupads {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Advertisers$Youtubeadgroupads$Get, options: StreamMethodOptions): GaxiosPromise<Readable>;
        get(params?: Params$Resource$Advertisers$Youtubeadgroupads$Get, options?: MethodOptions): GaxiosPromise<Schema$YoutubeAdGroupAd>;
        get(params: Params$Resource$Advertisers$Youtubeadgroupads$Get, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        get(params: Params$Resource$Advertisers$Youtubeadgroupads$Get, options: MethodOptions | BodyResponseCallback<Schema$YoutubeAdGroupAd>, callback: BodyResponseCallback<Schema$YoutubeAdGroupAd>): void;
        get(params: Params$Resource$Advertisers$Youtubeadgroupads$Get, callback: BodyResponseCallback<Schema$YoutubeAdGroupAd>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Advertisers$Youtubeadgroupads$List, options: StreamMethodOptions): GaxiosPromise<Readable>;
        list(params?: Params$Resource$Advertisers$Youtubeadgroupads$List, options?: MethodOptions): GaxiosPromise<Schema$ListYoutubeAdGroupAdsResponse>;
        list(params: Params$Resource$Advertisers$Youtubeadgroupads$List, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        list(params: Params$Resource$Advertisers$Youtubeadgroupads$List, options: MethodOptions | BodyResponseCallback<Schema$ListYoutubeAdGroupAdsResponse>, callback: BodyResponseCallback<Schema$ListYoutubeAdGroupAdsResponse>): void;
        list(params: Params$Resource$Advertisers$Youtubeadgroupads$List, callback: BodyResponseCallback<Schema$ListYoutubeAdGroupAdsResponse>): void;
        list(callback: BodyResponseCallback<Schema$ListYoutubeAdGroupAdsResponse>): void;
    }
    ...
    export class Resource$Advertisers$Youtubeadgroups {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        bulkListAdGroupAssignedTargetingOptions(params: Params$Resource$Advertisers$Youtubeadgroups$Bulklistadgroupassignedtargetingoptions, options: StreamMethodOptions): GaxiosPromise<Readable>;
        bulkListAdGroupAssignedTargetingOptions(params?: Params$Resource$Advertisers$Youtubeadgroups$Bulklistadgroupassignedtargetingoptions, options?: MethodOptions): GaxiosPromise<Schema$BulkListAdGroupAssignedTargetingOptionsResponse>;
        bulkListAdGroupAssignedTargetingOptions(params: Params$Resource$Advertisers$Youtubeadgroups$Bulklistadgroupassignedtargetingoptions, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        bulkListAdGroupAssignedTargetingOptions(params: Params$Resource$Advertisers$Youtubeadgroups$Bulklistadgroupassignedtargetingoptions, options: MethodOptions | BodyResponseCallback<Schema$BulkListAdGroupAssignedTargetingOptionsResponse>, callback: BodyResponseCallback<Schema$BulkListAdGroupAssignedTargetingOptionsResponse>): void;
        bulkListAdGroupAssignedTargetingOptions(params: Params$Resource$Advertisers$Youtubeadgroups$Bulklistadgroupassignedtargetingoptions, callback: BodyResponseCallback<Schema$BulkListAdGroupAssignedTargetingOptionsResponse>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Advertisers$Youtubeadgroups$Get, options: StreamMethodOptions): GaxiosPromise<Readable>;
        get(params?: Params$Resource$Advertisers$Youtubeadgroups$Get, options?: MethodOptions): GaxiosPromise<Schema$YoutubeAdGroup>;
        get(params: Params$Resource$Advertisers$Youtubeadgroups$Get, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        get(params: Params$Resource$Advertisers$Youtubeadgroups$Get, options: MethodOptions | BodyResponseCallback<Schema$YoutubeAdGroup>, callback: BodyResponseCallback<Schema$YoutubeAdGroup>): void;
        get(params: Params$Resource$Advertisers$Youtubeadgroups$Get, callback: BodyResponseCallback<Schema$YoutubeAdGroup>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Advertisers$Youtubeadgroups$List, options: StreamMethodOptions): GaxiosPromise<Readable>;
        list(params?: Params$Resource$Advertisers$Youtubeadgroups$List, options?: MethodOptions): GaxiosPromise<Schema$ListYoutubeAdGroupsResponse>;
        list(params: Params$Resource$Advertisers$Youtubeadgroups$List, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        list(params: Params$Resource$Advertisers$Youtubeadgroups$List, options: MethodOptions | BodyResponseCallback<Schema$ListYoutubeAdGroupsResponse>, callback: BodyResponseCallback<Schema$ListYoutubeAdGroupsResponse>): void;
        list(params: Params$Resource$Advertisers$Youtubeadgroups$List, callback: BodyResponseCallback<Schema$ListYoutubeAdGroupsResponse>): void;
        list(callback: BodyResponseCallback<Schema$ListYoutubeAdGroupsResponse>): void;
    }
    ...
    export class Resource$Advertisers$Youtubeadgroups$Targetingtypes$Assignedtargetingoptions {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Advertisers$Youtubeadgroups$Targetingtypes$Assignedtargetingoptions$Get, options: StreamMethodOptions): GaxiosPromise<Readable>;
        get(params?: Params$Resource$Advertisers$Youtubeadgroups$Targetingtypes$Assignedtargetingoptions$Get, options?: MethodOptions): GaxiosPromise<Schema$AssignedTargetingOption>;
        get(params: Params$Resource$Advertisers$Youtubeadgroups$Targetingtypes$Assignedtargetingoptions$Get, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        get(params: Params$Resource$Advertisers$Youtubeadgroups$Targetingtypes$Assignedtargetingoptions$Get, options: MethodOptions | BodyResponseCallback<Schema$AssignedTargetingOption>, callback: BodyResponseCallback<Schema$AssignedTargetingOption>): void;
        get(params: Params$Resource$Advertisers$Youtubeadgroups$Targetingtypes$Assignedtargetingoptions$Get, callback: BodyResponseCallback<Schema$AssignedTargetingOption>): void;
        get(callback: BodyResponseCallback<Schema$AssignedTargetingOption>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Advertisers$Youtubeadgroups$Targetingtypes$Assignedtargetingoptions$List, options: StreamMethodOptions): GaxiosPromise<Readable>;
        list(params?: Params$Resource$Advertisers$Youtubeadgroups$Targetingtypes$Assignedtargetingoptions$List, options?: MethodOptions): GaxiosPromise<Schema$ListYoutubeAdGroupAssignedTargetingOptionsResponse>;
        list(params: Params$Resource$Advertisers$Youtubeadgroups$Targetingtypes$Assignedtargetingoptions$List, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        list(params: Params$Resource$Advertisers$Youtubeadgroups$Targetingtypes$Assignedtargetingoptions$List, options: MethodOptions | BodyResponseCallback<Schema$ListYoutubeAdGroupAssignedTargetingOptionsResponse>, callback: BodyResponseCallback<Schema$ListYoutubeAdGroupAssignedTargetingOptionsResponse>): void;
        list(params: Params$Resource$Advertisers$Youtubeadgroups$Targetingtypes$Assignedtargetingoptions$List, callback: BodyResponseCallback<Schema$ListYoutubeAdGroupAssignedTargetingOptionsResponse>): void;
        list(callback: BodyResponseCallback<Schema$ListYoutubeAdGroupAssignedTargetingOptionsResponse>): void;
    }
