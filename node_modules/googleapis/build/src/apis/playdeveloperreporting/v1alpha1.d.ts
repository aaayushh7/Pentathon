...
export declare namespace playdeveloperreporting_v1alpha1 {
    ...
    export interface Schema$GooglePlayDeveloperReportingV1alpha1ErrorReport {
         ...
         */
        appVersion?: Schema$GooglePlayDeveloperReportingV1alpha1AppVersion;
        /**
    ...
    export class Resource$Anomalies {
        ...
        list(params?: Params$Resource$Anomalies$List, options?: MethodOptions): GaxiosPromise<Schema$GooglePlayDeveloperReportingV1alpha1ListAnomaliesResponse>;
        ...
        list(params: Params$Resource$Anomalies$List, options: MethodOptions | BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1ListAnomaliesResponse>, callback: BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1ListAnomaliesResponse>): void;
        list(params: Params$Resource$Anomalies$List, callback: BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1ListAnomaliesResponse>): void;
        list(callback: BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1ListAnomaliesResponse>): void;
    }
    ...
    export class Resource$Apps {
        ...
        fetchReleaseFilterOptions(params?: Params$Resource$Apps$Fetchreleasefilteroptions, options?: MethodOptions): GaxiosPromise<Schema$GooglePlayDeveloperReportingV1alpha1ReleaseFilterOptions>;
        ...
        fetchReleaseFilterOptions(params: Params$Resource$Apps$Fetchreleasefilteroptions, options: MethodOptions | BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1ReleaseFilterOptions>, callback: BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1ReleaseFilterOptions>): void;
        fetchReleaseFilterOptions(params: Params$Resource$Apps$Fetchreleasefilteroptions, callback: BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1ReleaseFilterOptions>): void;
        fetchReleaseFilterOptions(callback: BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1ReleaseFilterOptions>): void;
        /**
        ...
        search(params?: Params$Resource$Apps$Search, options?: MethodOptions): GaxiosPromise<Schema$GooglePlayDeveloperReportingV1alpha1SearchAccessibleAppsResponse>;
        ...
        search(params: Params$Resource$Apps$Search, options: MethodOptions | BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1SearchAccessibleAppsResponse>, callback: BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1SearchAccessibleAppsResponse>): void;
        search(params: Params$Resource$Apps$Search, callback: BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1SearchAccessibleAppsResponse>): void;
        search(callback: BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1SearchAccessibleAppsResponse>): void;
    }
    ...
    export class Resource$Vitals$Anrrate {
        ...
        get(params?: Params$Resource$Vitals$Anrrate$Get, options?: MethodOptions): GaxiosPromise<Schema$GooglePlayDeveloperReportingV1alpha1AnrRateMetricSet>;
        ...
        get(params: Params$Resource$Vitals$Anrrate$Get, options: MethodOptions | BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1AnrRateMetricSet>, callback: BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1AnrRateMetricSet>): void;
        get(params: Params$Resource$Vitals$Anrrate$Get, callback: BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1AnrRateMetricSet>): void;
        get(callback: BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1AnrRateMetricSet>): void;
        /**
        ...
        query(params?: Params$Resource$Vitals$Anrrate$Query, options?: MethodOptions): GaxiosPromise<Schema$GooglePlayDeveloperReportingV1alpha1QueryAnrRateMetricSetResponse>;
        ...
        query(params: Params$Resource$Vitals$Anrrate$Query, options: MethodOptions | BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1QueryAnrRateMetricSetResponse>, callback: BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1QueryAnrRateMetricSetResponse>): void;
        query(params: Params$Resource$Vitals$Anrrate$Query, callback: BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1QueryAnrRateMetricSetResponse>): void;
        query(callback: BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1QueryAnrRateMetricSetResponse>): void;
    }
    ...
    export class Resource$Vitals$Crashrate {
        ...
        get(params?: Params$Resource$Vitals$Crashrate$Get, options?: MethodOptions): GaxiosPromise<Schema$GooglePlayDeveloperReportingV1alpha1CrashRateMetricSet>;
        ...
        get(params: Params$Resource$Vitals$Crashrate$Get, options: MethodOptions | BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1CrashRateMetricSet>, callback: BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1CrashRateMetricSet>): void;
        get(params: Params$Resource$Vitals$Crashrate$Get, callback: BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1CrashRateMetricSet>): void;
        get(callback: BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1CrashRateMetricSet>): void;
        /**
         * Queries the metrics in the metric set.
         *
         * @param params - Parameters for request
        ...
        query(params?: Params$Resource$Vitals$Crashrate$Query, options?: MethodOptions): GaxiosPromise<Schema$GooglePlayDeveloperReportingV1alpha1QueryCrashRateMetricSetResponse>;
        ...
        query(params: Params$Resource$Vitals$Crashrate$Query, options: MethodOptions | BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1QueryCrashRateMetricSetResponse>, callback: BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1QueryCrashRateMetricSetResponse>): void;
        query(params: Params$Resource$Vitals$Crashrate$Query, callback: BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1QueryCrashRateMetricSetResponse>): void;
        query(callback: BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1QueryCrashRateMetricSetResponse>): void;
    }
    ...
    export class Resource$Vitals$Errors$Counts {
        ...
        get(params?: Params$Resource$Vitals$Errors$Counts$Get, options?: MethodOptions): GaxiosPromise<Schema$GooglePlayDeveloperReportingV1alpha1ErrorCountMetricSet>;
        ...
        get(params: Params$Resource$Vitals$Errors$Counts$Get, options: MethodOptions | BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1ErrorCountMetricSet>, callback: BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1ErrorCountMetricSet>): void;
        get(params: Params$Resource$Vitals$Errors$Counts$Get, callback: BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1ErrorCountMetricSet>): void;
        get(callback: BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1ErrorCountMetricSet>): void;
        /**
        ...
        query(params?: Params$Resource$Vitals$Errors$Counts$Query, options?: MethodOptions): GaxiosPromise<Schema$GooglePlayDeveloperReportingV1alpha1QueryErrorCountMetricSetResponse>;
        ...
        query(params: Params$Resource$Vitals$Errors$Counts$Query, options: MethodOptions | BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1QueryErrorCountMetricSetResponse>, callback: BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1QueryErrorCountMetricSetResponse>): void;
        query(params: Params$Resource$Vitals$Errors$Counts$Query, callback: BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1QueryErrorCountMetricSetResponse>): void;
        query(callback: BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1QueryErrorCountMetricSetResponse>): void;
    }
    ...
    export class Resource$Vitals$Errors$Issues {
        ...
        search(params?: Params$Resource$Vitals$Errors$Issues$Search, options?: MethodOptions): GaxiosPromise<Schema$GooglePlayDeveloperReportingV1alpha1SearchErrorIssuesResponse>;
        ...
        search(params: Params$Resource$Vitals$Errors$Issues$Search, options: MethodOptions | BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1SearchErrorIssuesResponse>, callback: BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1SearchErrorIssuesResponse>): void;
        search(params: Params$Resource$Vitals$Errors$Issues$Search, callback: BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1SearchErrorIssuesResponse>): void;
        search(callback: BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1SearchErrorIssuesResponse>): void;
    }
    ...
    export class Resource$Vitals$Errors$Reports {
        ...
        search(params?: Params$Resource$Vitals$Errors$Reports$Search, options?: MethodOptions): GaxiosPromise<Schema$GooglePlayDeveloperReportingV1alpha1SearchErrorReportsResponse>;
        ...
        search(params: Params$Resource$Vitals$Errors$Reports$Search, options: MethodOptions | BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1SearchErrorReportsResponse>, callback: BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1SearchErrorReportsResponse>): void;
        search(params: Params$Resource$Vitals$Errors$Reports$Search, callback: BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1SearchErrorReportsResponse>): void;
        search(callback: BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1SearchErrorReportsResponse>): void;
    }
    ...
    export class Resource$Vitals$Excessivewakeuprate {
        ...
        get(params?: Params$Resource$Vitals$Excessivewakeuprate$Get, options?: MethodOptions): GaxiosPromise<Schema$GooglePlayDeveloperReportingV1alpha1ExcessiveWakeupRateMetricSet>;
        ...
        get(params: Params$Resource$Vitals$Excessivewakeuprate$Get, options: MethodOptions | BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1ExcessiveWakeupRateMetricSet>, callback: BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1ExcessiveWakeupRateMetricSet>): void;
        get(params: Params$Resource$Vitals$Excessivewakeuprate$Get, callback: BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1ExcessiveWakeupRateMetricSet>): void;
        get(callback: BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1ExcessiveWakeupRateMetricSet>): void;
        /**
         * Queries the metrics in the metric set.
         *
         * @param params - Parameters for request
        ...
        query(params?: Params$Resource$Vitals$Excessivewakeuprate$Query, options?: MethodOptions): GaxiosPromise<Schema$GooglePlayDeveloperReportingV1alpha1QueryExcessiveWakeupRateMetricSetResponse>;
        ...
        query(params: Params$Resource$Vitals$Excessivewakeuprate$Query, options: MethodOptions | BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1QueryExcessiveWakeupRateMetricSetResponse>, callback: BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1QueryExcessiveWakeupRateMetricSetResponse>): void;
        query(params: Params$Resource$Vitals$Excessivewakeuprate$Query, callback: BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1QueryExcessiveWakeupRateMetricSetResponse>): void;
        query(callback: BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1QueryExcessiveWakeupRateMetricSetResponse>): void;
    }
    ...
    export class Resource$Vitals$Slowrenderingrate {
        ...
        get(params?: Params$Resource$Vitals$Slowrenderingrate$Get, options?: MethodOptions): GaxiosPromise<Schema$GooglePlayDeveloperReportingV1alpha1SlowRenderingRateMetricSet>;
        ...
        get(params: Params$Resource$Vitals$Slowrenderingrate$Get, options: MethodOptions | BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1SlowRenderingRateMetricSet>, callback: BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1SlowRenderingRateMetricSet>): void;
        get(params: Params$Resource$Vitals$Slowrenderingrate$Get, callback: BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1SlowRenderingRateMetricSet>): void;
        get(callback: BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1SlowRenderingRateMetricSet>): void;
        /**
         * Queries the metrics in the metric set.
         *
         * @param params - Parameters for request
        ...
        query(params?: Params$Resource$Vitals$Slowrenderingrate$Query, options?: MethodOptions): GaxiosPromise<Schema$GooglePlayDeveloperReportingV1alpha1QuerySlowRenderingRateMetricSetResponse>;
        ...
        query(params: Params$Resource$Vitals$Slowrenderingrate$Query, options: MethodOptions | BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1QuerySlowRenderingRateMetricSetResponse>, callback: BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1QuerySlowRenderingRateMetricSetResponse>): void;
        query(params: Params$Resource$Vitals$Slowrenderingrate$Query, callback: BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1QuerySlowRenderingRateMetricSetResponse>): void;
        query(callback: BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1QuerySlowRenderingRateMetricSetResponse>): void;
    }
    ...
    export class Resource$Vitals$Slowstartrate {
        ...
        get(params?: Params$Resource$Vitals$Slowstartrate$Get, options?: MethodOptions): GaxiosPromise<Schema$GooglePlayDeveloperReportingV1alpha1SlowStartRateMetricSet>;
        ...
        get(params: Params$Resource$Vitals$Slowstartrate$Get, options: MethodOptions | BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1SlowStartRateMetricSet>, callback: BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1SlowStartRateMetricSet>): void;
        get(params: Params$Resource$Vitals$Slowstartrate$Get, callback: BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1SlowStartRateMetricSet>): void;
        get(callback: BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1SlowStartRateMetricSet>): void;
        /**
         * Queries the metrics in the metric set.
         *
         * @param params - Parameters for request
        ...
        query(params?: Params$Resource$Vitals$Slowstartrate$Query, options?: MethodOptions): GaxiosPromise<Schema$GooglePlayDeveloperReportingV1alpha1QuerySlowStartRateMetricSetResponse>;
        ...
        query(params: Params$Resource$Vitals$Slowstartrate$Query, options: MethodOptions | BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1QuerySlowStartRateMetricSetResponse>, callback: BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1QuerySlowStartRateMetricSetResponse>): void;
        query(params: Params$Resource$Vitals$Slowstartrate$Query, callback: BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1QuerySlowStartRateMetricSetResponse>): void;
        query(callback: BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1QuerySlowStartRateMetricSetResponse>): void;
    }
    ...
    export class Resource$Vitals$Stuckbackgroundwakelockrate {
        ...
        get(params?: Params$Resource$Vitals$Stuckbackgroundwakelockrate$Get, options?: MethodOptions): GaxiosPromise<Schema$GooglePlayDeveloperReportingV1alpha1StuckBackgroundWakelockRateMetricSet>;
        ...
        get(params: Params$Resource$Vitals$Stuckbackgroundwakelockrate$Get, options: MethodOptions | BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1StuckBackgroundWakelockRateMetricSet>, callback: BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1StuckBackgroundWakelockRateMetricSet>): void;
        get(params: Params$Resource$Vitals$Stuckbackgroundwakelockrate$Get, callback: BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1StuckBackgroundWakelockRateMetricSet>): void;
        get(callback: BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1StuckBackgroundWakelockRateMetricSet>): void;
        /**
         * Queries the metrics in the metric set.
         *
         * @param params - Parameters for request
        ...
        query(params?: Params$Resource$Vitals$Stuckbackgroundwakelockrate$Query, options?: MethodOptions): GaxiosPromise<Schema$GooglePlayDeveloperReportingV1alpha1QueryStuckBackgroundWakelockRateMetricSetResponse>;
        ...
        query(params: Params$Resource$Vitals$Stuckbackgroundwakelockrate$Query, options: MethodOptions | BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1QueryStuckBackgroundWakelockRateMetricSetResponse>, callback: BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1QueryStuckBackgroundWakelockRateMetricSetResponse>): void;
        query(params: Params$Resource$Vitals$Stuckbackgroundwakelockrate$Query, callback: BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1QueryStuckBackgroundWakelockRateMetricSetResponse>): void;
        query(callback: BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1QueryStuckBackgroundWakelockRateMetricSetResponse>): void;
    }
