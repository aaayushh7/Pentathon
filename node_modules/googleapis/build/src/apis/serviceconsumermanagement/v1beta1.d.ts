...
export declare namespace serviceconsumermanagement_v1beta1 {
    ...
    export class Resource$Services$Properties {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        create(params: Params$Resource$Services$Properties$Create, options: StreamMethodOptions): GaxiosPromise<Readable>;
        create(params?: Params$Resource$Services$Properties$Create, options?: MethodOptions): GaxiosPromise<Schema$V1Beta1ConsumerProperty>;
        create(params: Params$Resource$Services$Properties$Create, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        create(params: Params$Resource$Services$Properties$Create, options: MethodOptions | BodyResponseCallback<Schema$V1Beta1ConsumerProperty>, callback: BodyResponseCallback<Schema$V1Beta1ConsumerProperty>): void;
        create(params: Params$Resource$Services$Properties$Create, callback: BodyResponseCallback<Schema$V1Beta1ConsumerProperty>): void;
        create(callback: BodyResponseCallback<Schema$V1Beta1ConsumerProperty>): void;
    }
    export interface Params$Resource$Services$Properties$Create extends StandardParameters {
        /**
