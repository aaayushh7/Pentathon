...
(function (serviceconsumermanagement_v1beta1) {
    ...
    class Resource$Services$Properties {
        constructor(context) {
            this.context = context;
        }
        create(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v1beta1/{+parent}/properties').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST',
                }, options),
                params,
                requiredParams: ['parent'],
    ...
    serviceconsumermanagement_v1beta1.Resource$Services$Properties = Resource$Services$Properties;
